...
class SpotsListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        spots = Spots()
        spots.spotArray.append(Spot(name: "Galatoires", address: "Bourbon St.", coordinate: CLLocationCoordinate2D(), averageRating: 0.0, numberOfReviews: 0, postingUserID: "", documentID: ""))
        spots.spotArray.append(Spot(name: "Shake Shack", address: "St. Chestnut Hill", coordinate: CLLocationCoordinate2D(), averageRating: 0.0, numberOfReviews: 0, postingUserID: "", documentID: ""))
